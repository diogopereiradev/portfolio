...
function SocialLinks(): JSX.Element {
  return(
    <ul className='flex items-center lg:gap-[15px] mmd:gap-[10px]'>
      <SocialLink to='https://github.com/FhillSlinger' icon={<FaGithub size={30}/>}/>
      <SocialLink to='https://codepen.io/fhillslinger/pens/public' icon={<FaCodepen size={31}/>}/>
      <SocialLink to='https://www.linkedin.com/in/fhill-slinger/' icon={<FaLinkedin size={31}/>}/>
      <SocialLink to='https://discord.com/users/882178309205671956' icon={<FaDiscord size={33}/>}/>
    </ul>
  );
}
