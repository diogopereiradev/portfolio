...
export function Banner(): JSX.Element {
  ...
  return (
    <div className='relative before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-[#0000006b] border-b-[2px] border-primary-200 border-solid'>
      <Image className='w-full h-[110px] object-cover' loading='lazy' loader={({ src }) => src} src={projectThumbImageUrl} width={512} height={130} alt='thumbnail' unoptimized={projectThumbImageUrl.startsWith('https://')? false : true}/>
